...
def query_recur_ns (domain_name,ns_addr,root_addr,if_print,original):
    ...
    if len(final_ns_array)>0:
        ...
        tmp_a = query_recur_a(ns_array[0],root_addr,root_addr,False,original)
...
def query_recur_a (domain_name,ns_addr,root_addr,if_print,original):
    ...
    if len(response.answer) > 0:
        ...
        # print 'len(a_array)>0:'
            ...
            tmp_a = query_recur_a(ans_ns[0],root_addr,dns,root_addr,False,original)
...
root_array =['198.41.0.4','192.228.79.201','192.33.4.12','199.7.91.13','192.203.230.10','192.5.5.241','192.112.36.4','198.97.190.53','192.36.148.17','192.58.128.30','193.0.14.129','199.7.83.42','202.12.27.33']
...
public_resolver.nameservers = ['8.8.8.8']
 
for site in site_array:
    a = datetime.datetime.now() 
    for i in xrange(10):   
        result = public_resolver.query(site, "A")
        # for rdata in result:
        #             print rdata
    b = datetime.datetime.now()
    c = (b - a).microseconds/1000
    c=c/10
    print c,'msec','for',site
...
'Youtube.com',
'Yahoo.com',
'Amazon.com','Wikipedia.org','Google.co.in',
'Twitter.com',
'Live.com','Msn.com',
'Yahoo.co.jp',
'Linkedin.com','Google.co.jp','Vk.com','Bing.com','Yandex.ru',
'Ebay.com','Instagram.com',
'Google.de'
]



print 'my_own_resolver'
...
for site in site_array:
	...
	a = datetime.datetime.now()
	for j in xrange(10):
		result = query_recur_a(site,root,root,False,site)
...
# 'Linkedin.com','Yandex.ru',
# 'Ebay.com','Instagram.com',

# ]

# # site_array = [
# # 'Baidu.com','Weibo.com','Bing.com','Hao123.com']



# type = sys.argv[1]
# # for site in site_array:
# # 	subprocess.call([sys.executable, 'mydig.py', site, type])


# # for site in site_array:
# # 	subprocess.call([sys.executable, 'mydnsresolver.py', site])
...
# subprocess.call([sys.executable, 'mydig.py', site_array[0], type])
