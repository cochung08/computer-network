...
//				 System.out.println("ackNumber: " + ack);
...
//			System.out.println("flow " + i + ":  goodput:  : " + goodput + " byte per second");
			...
			for (int k = 1; k < tmp2.size(); k++) {
				Packet packet = tmp2.get(k);
				
				System.out.println("packet from  " + packet.ipSrc + "  port: " + packet.srcPort  + " to "
						+ packet.ipDest + "  port: " + packet.destPort+"   seq num: "+ packet.seq +" ack num "+packet.ack+" window size "+  packet.window);
				
			}
			
			
			
			String local_ip = a1.ipSrc;
...
//							 System.out.println("rtt number: " + rtt_number+"  from packet "+(k + 1) +" to "+"packet "+ (j +
//							 1));
							 
//							 System.out.println("rtt:_" + rtt + "millsecond");
...

							{
								...
								double rtt3 = getRTT(first_packet, ack_packet);
		
								initial_cw = initial_cw + mss;
//								 System.out.println("rtt3:_" + rtt3 + "millsecond       "+"congestion window size :" + initial_cw);
							}
...
//							 System.out.println("srtt: " + srtt+ " millisecond");
//							 System.out.println("rttvar: " + rttvar +" millisecond");
//							 System.out.println("rto: " + rto +" millisecond");
//							 System.out.println();
